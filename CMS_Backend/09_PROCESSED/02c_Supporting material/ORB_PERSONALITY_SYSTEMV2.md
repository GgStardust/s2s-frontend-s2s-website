...
orb_associations:
  primary_orb: "Orb 0: Existential Architecture"
  secondary_orbs:
...
field_function:
  content_purpose: "Provides complete personality system for all 13 Orbs, establishes voice consistency across S2S content, creates character profiles for essay development and user experience, enables personality-driven content creation and consulting"
  primary_mechanism: "Orb 0: Existential Architecture - provides universal personality framework for all Orbs (universal → specific through personality profiles and voice guidance)"
  secondary_mechanisms:
    - "All 13 Orbs - each with unique personality traits, communication styles, cultural archetypes, scientific authority, mystical heritage, and unique gifts"
  mentions: "All 13 Orbs (comprehensive personality system)"
...
book_threading: "orb_personality_system"
...
# System Integration
source_file: "ORB_PERSONALITY_SYSTEMV2.md"
rewrite_locked: false
dashboard_component: "orb_personality_system"
codex_destination: "/orb_framework/personality_system/"
