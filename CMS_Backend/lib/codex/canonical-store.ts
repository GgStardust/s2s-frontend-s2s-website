...
export class CanonicalStore {
  ...
  async initialize(): Promise<void> {
    ...
    const canonicalFiles = [
      {
        path: '09_PROCESSED/02c_Supporting material/CANONICAL_13_ORB_SYSTEM_REFERENCE.md',
        type: 'orb_system' as const,
        id: 'canonical_13_orb_system'
      },
      {
        path: '09_PROCESSED/02c_Supporting material/codex_Orb_Synthesis_Final.md',
        type: 'orb_system' as const,
        id: 'orb_synthesis_final'
      },
      {
        path: '09_PROCESSED/02c_Supporting material/S2S — Undercurrents Codex.md',
        type: 'undercurrents' as const,
        id: 'undercurrents_codex'
      },
      {
        path: '09_PROCESSED/02c_Supporting material/03_Language_and_Definitions_CLEAN.md',
      ...
      {
        path: '09_PROCESSED/02c_Supporting material/I_Written_System_Description_CLEAN.md',
