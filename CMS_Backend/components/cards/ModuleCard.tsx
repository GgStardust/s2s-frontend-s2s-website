...
export default function ModuleCard({ module }: ModuleCardProps) {
  return (
    <Link 
      ...
      className="group block bg-deep-navy rounded-2xl shadow-md hover:shadow-lg transition-shadow duration-200 p-6"
    >
      ...
      <p className="text-creamy-white/80 font-lora text-sm leading-relaxed line-clamp-3">
        {module.summary}
      </p>
      
      <div className="mt-4 flex items-center text-deep-gold font-montserrat text-sm uppercase tracking-wide group-hover:text-creamy-white transition-colors duration-200">
        Explore Module
