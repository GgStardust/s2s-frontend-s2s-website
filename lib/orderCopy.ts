...
export const ORDER_WHOLESALE_NOTE = 'Wholesale:' as const

export const ORDER_SUCCESS_PAID =
  'Your order for The Cosmic Tapestry is confirmed. You will receive email confirmation shortly.' as const
