...
export const BOOK_ONE = {
  ...
  purchaseLabel: 'Purchase the current first edition',
};
...
export const BOOK_STATUS = {
  ...
  title: 'Availability',
  body:
    'The current first edition of The Cosmic Tapestry remains available for direct purchase.',
  note:
    'I am also reading the manuscript again, line by line. A later edition may change.',
};
